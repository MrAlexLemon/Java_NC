...
/**
 * <h1>MergeSortBubbleDown</h1>
 * <p>This class sorts array using MergeSortBubbleDown.</p>
 * <p>MergeSortBubbleDown extends AbstarctSorter.</p>
...
public class MergeSortBubbleDown extends AbstarctSorter{
    ...
    /**
     * <p>This method sort array using MergeSortBubbleDown</p>
     ...
     */
    @Override
    @Description(name = "MergeSortBubbleDown",
            args = "int[] arr",
            desc = "Sort array using MergeSortBubbleDown",
            aliases = {""})
    public int[] sort(int[] arr) {
    ...
    public int[] tempSort(int[] arr) throws InterruptedException{
        ...
        if(Runtime.getRuntime().availableProcessors()>=threadCount) {
            ...
            BubbleSortDown bsd = new BubbleSortDown();
            bsd.sort(arr);
            tempArr=arr;
        }
        return  tempArr;
