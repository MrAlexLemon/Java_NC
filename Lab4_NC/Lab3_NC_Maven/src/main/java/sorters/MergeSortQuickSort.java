...
/**
 * <h1>MergeSortQuickSort</h1>
 * <p>This class sorts array using MergeSortQuickSort.</p>
 * <p>MergeSortQuickSort extends AbstarctSorter.</p>
 * <p>This class has override method - public int[] sort(int[] arr)</p>
 * @author Khomenko Olexandr
 * @version 1.3
 */
public class MergeSortQuickSort extends AbstarctSorter {
    private QuickSort bs= new QuickSort();
    //private FillArray fa = new RandomFillArray(7,100);

    /**
     * <p>Use hybrid. Merge sort + QuickSort</p>
    ...
    /**
     * <p>This method sort array using MergeSortQuickSort</p>
     * @param arr - start array
     ...
     */
    @Override
    @Description(name = "MergeSortQuickSort",
            args = "int[] arr",
            desc = "Sort array using MergeSortQuickSort",
            aliases = {""})
    public int[] sort(int[] arr) {
        //int[] arr= obj.fillArray();
        if (arr.length == 0)
